export const UPPERKEY = [
  'ShiftLeft',
  'CapsLock',
  'ShiftRight',
];

export const KEY_CODE = ['Backquote', 'Digit1', 'Digit2', 'Digit3', 'Digit4', 'Digit5', 'Digit6', 'Digit7', 'Digit8', 'Digit9',
  ...
  'Slash', 'ArrowUp', 'ShiftRight', 'ControlLeft', 'MetaLeft', 'AltLeft', 'Lang', 'Sound', 'Space', 'Rec', 'AltRight', 'ArrowLeft', 'ArrowDown', 'ArrowRight',
  'ControlRight'];
...
const KEYS_EN = ['`', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '-', '=', 'Backspace',
  ...
  'Ctrl', 'Win', 'Alt', 'en<span>ru</span>', '&#128276;', 'Space', 'rec', 'Alt ', '◄', '▼', '►', 'Ctrl ',
];
...
const KEYS_RU = ['ё', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '-', '=', 'Backspace',
  ...
  'Ctrl', 'Win', 'Alt', 'ru<span>en</span>', '&#128276;', 'Space', 'rec', 'Alt ', '◄', '▼', '►', 'Ctrl ',
];
